...
var gr_InstallPath = "";// "/p1506.webapp/static/control";
// //实际项目中应该写从根目录寻址的目录，如gr_InstallPath="/myapp/report/grinstall";
...
// 以 ReportDesigner 为 ID 创建报表设计器插件(Designer)，插件大小为100%充满位置区域，参数说明参考
// CreateDesignerEx
...
(function()
{
	...
	gr_InstallPath = ctxp + '/static/control';
	if (_gr_isIE)
		gr_CodeBase = 'codebase="' + gr_InstallPath + '/grbsctl5.cab#Version=' + gr_Version + '"';
