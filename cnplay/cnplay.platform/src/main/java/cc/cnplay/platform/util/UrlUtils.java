...
public final class UrlUtils
{
	public static void main(String[] args) throws JsonProcessingException, UnsupportedEncodingException
	{
		...
		CheckLog item = new CheckLog();
		item.setId("a");
		item.setCheckJson("123");
	...
	public static String buildFullContextPath(HttpServletRequest r)
	{
		...
		url.append(r.getContextPath());
		return url.toString();
	}

	public static String buildContextPath(HttpServletRequest r)
	{
		String serverName = r.getServerName();
		int serverPort = r.getServerPort();
		StringBuilder url = new StringBuilder();
	 ...
	 * @return
	 */
	public static String buildUrl(HttpServletRequest r)
	{
		return buildRequestUrl(r.getServletPath(), r.getRequestURI(), r.getContextPath(), r.getPathInfo(), null);
	}
