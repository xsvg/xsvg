/*
 * File: app/view/SystemConfigPanel.js
 *
...
Ext.define('platform.tools.view.SystemConfigPanel', {
    ...
    onDelClick: function(button, e, eOpts) {
        ...
        Common.deleteSelectionIds(this,ctxp+'/system/systemConfig/remove');
    },

    onButtonDeleteAfterRender: function(component, eOpts) {
        this.btnDel = component;
        Common.hidden({params : {url:'/system/systemConfig/remove'},component:component});
    },
    ...
    loadGrid: function() {
        ...
        try{
            Common.loadStore({
                component:this,
                url:ctxp + '/system/systemConfig/list',
    ...
    showForm: function(id) {
        ...
        {
            var me = this;
            var formwin = Ext.create('platform.tools.view.SystemCfgWin');
